          ...
          <v-card class="card">
            ...
            <div class="card-header card-header-primary card-header-info">
              ...
              <v-row>
                ...
                <!-- 批量操作 -->
                <v-col cols="2" align-self="center" v-if="!isSelect">
                  <v-btn @click="isSelect = true">
                    批量操作
                  </v-btn>
                </v-col>
                <v-col cols="2" v-else align-self="center">
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "分类", value: "content", sortable: false },
      { text: "", value: "createdAt", sortable: true },
